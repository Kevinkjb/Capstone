...
function playerMove(champion){
    ...
    if(champion === 'rock'){
        if('rock' === computerMove){
            result = 'draw';
            championVersus.innerHTML = `You: <img  class='rock-paper-scissors-img' src="images/rock.png"> Comp: <img class='rock-paper-scissors-img' src="images/${computerMove}.png">`
        ...
        if(computerMove === 'paper' ){
            result = 'draw';
            championVersus.innerHTML = `You: <img class='rock-paper-scissors-img' src="images/paper.png"> Comp: <img class='rock-paper-scissors-img' src="images/${computerMove}.png">`
        ...
        if('scissors' === computerMove){
            result = 'draw';
            championVersus.innerHTML = `You: <img class='rock-paper-scissors-img' src="images/scissors.png"> Comp: <img class='rock-paper-scissors-img' src="images/${computerMove}.png">`
